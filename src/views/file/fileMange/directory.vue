<template>
    <el-container class="my_directory">
            ...
            <el-container class="table_box">
                ...
                <el-main class="table_content">
                    ...
                    >
                        ...
                        <el-table-column label="文件名" min-width="45%" show-overflow-tooltip align="center">
                        ...
                        <el-table-column label="操作" min-width="40%" show-overflow-tooltip align="center">
                            <template slot-scope="scope">
                                <el-button type="text" @click.stop="previewFile(scope.$index)">{{ directoryFileList[scope.$index].canPreview ? '预览' : '申请预览' }}</el-button>
        ...
        <el-dialog width="650px" :title="innerDialogTitle" :visible.sync="innerDialogVisible">
            <template>
                <AsideTree ref="innerDirectoryTree" style="height: 300px" :tree="directoryTree" :filter="false" v-on:chooseNode="chooseInnerNode" />
            </template>
...
export default {
    ...
    methods: {
        ...
        chooseNode(data) {
            ...
            this.$store.commit('directory/setCurrentDirectoryNode', this.currentDirectory)
        ...
        //新增公共目录
        createHandler() {
            Utils.ObjectInit(this.directoryForm)
            this.dialogDirectoryVisible = true
            this.dialogDirectoryTitle = '新增公共目录'
        },
        modifyHandler() {
            this.dialogDirectoryVisible = true
            this.dialogDirectoryTitle = '修改公共目录'
            this.directoryForm.name = this.currentDirectory.name
        },
...
<style scopedSlots>
.my_directory .el-tree > .el-tree-node > .el-tree-node__content {
    font-weight: 700;
}
.my_directory .table_content .el-button {
    padding: 0 5px;
}
.my_directory .upload_box {
    height: 200px;
}
.my_directory .upload_wraper .el-table--scrollable-y .el-table__body-wrapper {
    height: 162px !important;
}
.my_directory .main_table .weight-row {
